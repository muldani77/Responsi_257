package com.example.responsi_257.adapter
...
class ListPresidenAdapter(private val listPresiden: ArrayList<Presiden>)
    : RecyclerView.Adapter<ListPresidenAdapter.PresidenViewHolder>()
{
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PresidenViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.daftar_presiden, parent, false)
